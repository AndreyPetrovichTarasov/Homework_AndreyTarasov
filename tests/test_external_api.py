...
def test_converting_payment(mock_get):
    ...
    assert converting_payment({'id': 441945886,
                                ...
                                'description': 'Перевод организации',
                                'from': 'Maestro 1596837868705199',
                                'to': 'Счет 64686473678894779589'}) == "Платеж совершен в USD. Сумма в рублях: 1.0"
    mock_get.assert_called_once_with(f"https://api.apilayer.com/exchangerates_data/convert", headers={'apikey': 'ws2JCB2959nUCODmE0dTTmn1joOQV2yf'}, params={'amount': '1.0', 'from': 'USD', 'to': 'RUB'})
